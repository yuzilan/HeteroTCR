...
ggsave("fig8e.pdf",p_Hetero_UMI_donor1,device = "pdf",width=10,height=9,units="cm")
...
p_Hetero_UMI_donor2 = ggplot(Hetero_donor2, aes(x = fraction, y = probability)) +
            ...
            theme(panel.grid=element_blank(),
                ...
                axis.text = element_text(size = 6, family = "Helvetica"))+
            scale_y_continuous(limits=c(0,1))
ggsave("fig8f.pdf",p_Hetero_UMI_donor2,device = "pdf",width=10,height=9,units="cm")
...
p_Hetero_UMI_donor3 = ggplot(Hetero_donor3, aes(x = fraction, y = probability)) +
            ...
            theme(panel.grid=element_blank(),
                ...
                axis.text = element_text(size = 6, family = "Helvetica"))+
            scale_y_continuous(limits=c(0,1))
ggsave("fig8g.pdf",p_Hetero_UMI_donor3,device = "pdf",width=10,height=9,units="cm")
...
p_Hetero_UMI_donor4 = ggplot(Hetero_donor4, aes(x = fraction, y = probability)) +
            ...
            theme(panel.grid=element_blank(),
                ...
                axis.text = element_text(size = 6, family = "Helvetica"))+
            scale_y_continuous(limits=c(0,1))
ggsave("fig8h.pdf",p_Hetero_UMI_donor4,device = "pdf",width=10,height=9,units="cm")